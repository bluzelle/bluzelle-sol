...
import "github.com/bluzelle/bluzelle-sol/contracts/BluzelleClient.sol"; //"./BluzelleClient.sol";

contract SampleDappPublic is BluzelleClient {
    ...
    function SampleDappPublic(string _uuid) public {
        owner = msg.sender;
        changeUUID(_uuid); 
    }
    ...
    function getValue(string _key) public payable {
        read(_key);
    }
    ...
    /* Create new KVP */
    function add(string _key, string _value) public payable {
        create(_key, _value);
    }
    
    /* Remove a KVP */
    function eliminate(string _key) public payable {
        remove(_key);
    }
